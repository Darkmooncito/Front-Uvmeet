...
export default function About() {
  ...
  return (
    <div className="about-container" onClick={() => setOpenMenu(false)}>
      ...
      <header className="about-header">
        ...
        <nav className="navbar">
          <button className="nav-link" onClick={() => navigate("/home")}>inicio</button>
      ...
      <main className="about-main">
        <div className="about-card">
          ...
          <p>En UV Meet, conectamos ideas, personas y proyectos.</p>
        </div>
      </main>

      <footer className="about-footer" ref={footerRef}>
